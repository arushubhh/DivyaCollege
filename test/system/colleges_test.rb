...
class CollegesTest < ApplicationSystemTestCase
  ...
  test "should create college" do
    ...
    fill_in "City", with: @college.city
    fill_in "Contact email", with: @college.contact_email
    fill_in "Contact no", with: @college.contact_no
    fill_in "Description", with: @college.description
