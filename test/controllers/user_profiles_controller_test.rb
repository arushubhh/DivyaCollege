...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference("UserProfile.count") do
      post user_profiles_url, params: { user_profile: { address: @user_profile.address, city_id: @user_profile.city_id, country_id: @user_profile.country_id, date_of_birth: @user_profile.date_of_birth, first_name: @user_profile.first_name, gender: @user_profile.gender, last_name: @user_profile.last_name, phone: @user_profile.phone, state_id: @user_profile.state_id, user_id: @user_profile.user_id } }
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { address: @user_profile.address, city_id: @user_profile.city_id, country_id: @user_profile.country_id, date_of_birth: @user_profile.date_of_birth, first_name: @user_profile.first_name, gender: @user_profile.gender, last_name: @user_profile.last_name, phone: @user_profile.phone, state_id: @user_profile.state_id, user_id: @user_profile.user_id } }
