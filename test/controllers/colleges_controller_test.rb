...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference("College.count") do
      post colleges_url, params: { college: { city: @college.city, contact_email: @college.contact_email, contact_no: @college.contact_no, description: @college.description, name: @college.name } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { city: @college.city, contact_email: @college.contact_email, contact_no: @college.contact_no, description: @college.description, name: @college.name } }
