...
ActiveRecord::Schema[7.0].define(version: 2022_11_20_092843) do
  ...
  create_table "college_eligibility_criteria", force: :cascade do |t|
    t.bigint "college_id", null: false
    t.float "minimum_eligibility_percentage"
    t.string "year"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["college_id"], name: "index_college_eligibility_criteria_on_college_id"
  end
  ...
  add_foreign_key "college_eligibility_criteria", "colleges"
